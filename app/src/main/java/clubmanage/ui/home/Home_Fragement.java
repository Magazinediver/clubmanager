...
import clubmanage.ui.ActiviytsPage;
import clubmanage.ui.FragmentAdapter;
import clubmanage.ui.R;
import clubmanage.util.ClubManageUtil;

public class Home_Fragement extends Fragment implements View.OnClickListener{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        fragmentList.add(new Home_TabFragment2(title[0]));
        fragmentList.add(new Home_TabFragment1(title[1]));
