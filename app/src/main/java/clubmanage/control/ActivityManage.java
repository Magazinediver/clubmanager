...
public class ActivityManage implements IActivityManage {
    ...
    public List<Activity> searchAllActivity() {
        ...
        try {
            conn = DBUtil.getConnection();
            String sql = "select activity_id,club_id,activity_name,poster,activity_start_time,activity_end_time,activity_introduce,activity_place,activity_attention,if_public_activity,activity_category from activity";
            java.sql.PreparedStatement pst = conn.prepareStatement(sql);
            java.sql.ResultSet rs = pst.executeQuery();
            while (rs.next()) {
    ...
    public List<Activity> searchActivityByName(String activity_name) {
        ...
        try {
            conn = DBUtil.getConnection();
            String sql = "select activity_id,club_id,activity_name,poster,activity_start_time,activity_end_time,activity_introduce,activity_place,activity_attention,if_public_activity,activity_category from activity where activity_name like '%"+activity_name+"%'";
            java.sql.PreparedStatement pst = conn.prepareStatement(sql);
            java.sql.ResultSet rs = pst.executeQuery();
            while (rs.next()) {
                Activity activity = new Activity();
    ...
    public List<Activity> searchActivityByCategory(String category){
        ...
        try {
            conn = DBUtil.getConnection();
            String sql = "select activity_id,club_id,activity_name,poster,activity_start_time,activity_end_time,activity_introduce,activity_place,activity_attention,if_public_activity,activity_category from activity where activity_category=?";
            java.sql.PreparedStatement pst = conn.prepareStatement(sql);
